...
private object InteractiveMediaAdsLibraryPigeonUtils {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    ...
    if (value is com.google.ads.interactivemedia.v3.api.AdDisplayContainer) {
      registrar.getPigeonApiAdDisplayContainer().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdDisplayContainer", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiBaseDisplayContainer().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("BaseDisplayContainer", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdsLoader().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdsLoader", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdsManagerLoadedEvent().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdsManagerLoadedEvent", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdsRequest().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdsRequest", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiContentProgressProvider().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("ContentProgressProvider", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdsManager().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdsManager", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiImaSdkFactory().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("ImaSdkFactory", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiImaSdkSettings().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("ImaSdkSettings", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiVideoProgressUpdate().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("VideoProgressUpdate", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdMediaInfo().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdMediaInfo", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiMediaPlayer().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("MediaPlayer", value, it.exceptionOrNull())
        }
      }
    } else if (value
      ...
      registrar.getPigeonApiVideoAdPlayerCallback().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("VideoAdPlayerCallback", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiVideoAdPlayer().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("VideoAdPlayer", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdsLoadedListener().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdsLoadedListener", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdErrorListener().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdErrorListener", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdEventListener().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdEventListener", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdsRenderingSettings().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdsRenderingSettings", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiAdProgressInfo().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("AdProgressInfo", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCompanionAd().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CompanionAd", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiUniversalAdId().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("UniversalAdId", value, it.exceptionOrNull())
        }
      }
    } else if (value is com.google.ads.interactivemedia.v3.api.Ad) {
      registrar.getPigeonApiAd().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("Ad", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCompanionAdSlotClickListener().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CompanionAdSlotClickListener", value, it.exceptionOrNull())
        }
      }
...
abstract class PigeonApiAdError(
  ...
  fun pigeon_newInstance(
    ...
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      channel.send(
          listOf(
              pigeon_identifierArg, errorCodeArg, errorCodeNumberArg, errorTypeArg, messageArg)) {
            if (it is List<*>) {
              if (it.size > 1) {
                callback(
                    Result.failure(
...
abstract class PigeonApiImaSdkSettings(
   ...
   *
   * This should be set as early as possible, before requesting ads. Settings will remain constant
   * until the next ad request. Calling this method again will reset any feature flags for the next
   * ad request.
   */
   ...
   *
   * The supported codes can be found in the Localization guide and are closely related to the
   ...
   *
   * Player type greater than 20 characters will be truncated. The player type specified should be
   * short and unique.
   */
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg =
                args[0] as com.google.ads.interactivemedia.v3.api.ImaSdkSettings
            val maxRedirectsArg = args[1] as Long
            val wrapped: List<Any?> =
                try {

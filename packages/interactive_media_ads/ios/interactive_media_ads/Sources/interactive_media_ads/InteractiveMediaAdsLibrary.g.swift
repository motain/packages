...
enum InteractiveMediaAdsLibraryPigeonInternal {
...
open class InteractiveMediaAdsLibraryPigeonProxyApiRegistrar {
  ...
  func setUp() {
    ...
    PigeonApiIMASettings.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiIMASettings(self))
...
enum AdErrorType: Int, CaseIterable {
...
enum AdErrorCode: Int, CaseIterable {
...
enum AdEventType: Int, CaseIterable {
...
enum FriendlyObstructionPurpose: Int, CaseIterable {
...
enum UIElementType: Int, CaseIterable {
      ...
      completion(
        .failure(
          PigeonError(
            ...
            message:
              "Callback to `UIViewController.viewDidAppear` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
...
protocol PigeonApiDelegateIMASettings {
  ...
  func setFeatureFlags(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, flags: [String: String]) throws
  /// Enable background audio playback for the SDK.
  ///
  /// The default value is false.
  func setEnableBackgroundPlayback(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, enabled: Bool) throws
  /// Specifies whether to automatically play VMAP and ad rules ad breaks.
  ///
  /// The default value is true.
  func setAutoPlayAdBreaks(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, autoPlay: Bool) throws
  ...
  func setDisableNowPlayingInfo(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, disable: Bool) throws
  ...
  func setPlayerVersion(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, version: String?) throws
  ...
  func setSessionID(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, sessionID: String?) throws
  ...
  func setEnableDebugMode(
    pigeonApi: PigeonApiIMASettings, pigeonInstance: IMASettings, enable: Bool) throws
}
...
final class PigeonApiIMASettings: PigeonApiProtocolIMASettings {
  ...
  static func setUpMessageHandlers(
    binaryMessenger: FlutterBinaryMessenger, api: PigeonApiIMASettings?
  ) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
      ...
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.pigeon_defaultConstructor",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
    ...
    let setPPIDChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setPPID",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setPPIDChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setPPID(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, ppid: ppidArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setLanguageChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setLanguage",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setLanguageChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setLanguage(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, language: languageArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setMaxRedirectsChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setMaxRedirects",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setMaxRedirectsChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setMaxRedirects(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, max: maxArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setFeatureFlagsChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setFeatureFlags",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setFeatureFlagsChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setFeatureFlags(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, flags: flagsArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setEnableBackgroundPlaybackChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setEnableBackgroundPlayback",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setAutoPlayAdBreaksChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setAutoPlayAdBreaks",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAutoPlayAdBreaksChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setAutoPlayAdBreaks(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, autoPlay: autoPlayArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setDisableNowPlayingInfoChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setDisableNowPlayingInfo",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setDisableNowPlayingInfoChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setDisableNowPlayingInfo(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, disable: disableArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setPlayerTypeChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setPlayerType",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setPlayerTypeChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setPlayerType(
    ...
    let setPlayerVersionChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setPlayerVersion",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setPlayerVersionChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setPlayerVersion(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, version: versionArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setSessionIDChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setSessionID",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setSessionIDChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setSessionID(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, sessionID: sessionIDArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setSameAppKeyEnabledChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setSameAppKeyEnabled",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setEnableDebugModeChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMASettings.setEnableDebugMode",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
protocol PigeonApiDelegateIMAAdsRequest {
  ...
  func withAdsResponse(
    ...
    adDisplayContainer: IMAAdDisplayContainer, contentPlayhead: IMAContentPlayhead?
  ) throws -> IMAAdsRequest
  ...
  func setAdWillAutoPlay(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, adWillAutoPlay: Bool) throws
  /// Specifies whether the player intends to start the content and ad with no
  /// volume.
  ///
  /// Changing this setting will have no impact on ad playback.
  func setAdWillPlayMuted(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, adWillPlayMuted: Bool) throws
  ...
  func setContentDuration(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, duration: Double) throws
  /// Specifies the keywords used to describe the content to be shown.
  ///
  /// Used in AdX requests. This parameter is optional.
  func setContentKeywords(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, keywords: [String]?) throws
  /// Specifies the title of the content to be shown.
  ///
  /// Used in AdX requests. This parameter is optional.
  func setContentTitle(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, title: String?) throws
  ...
  func setContentURL(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, contentURL: String?) throws
  ...
  func setVastLoadTimeout(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, timeout: Double) throws
  ...
  func setLiveStreamPrefetchSeconds(
    pigeonApi: PigeonApiIMAAdsRequest, pigeonInstance: IMAAdsRequest, seconds: Double) throws
}
...
final class PigeonApiIMAAdsRequest: PigeonApiProtocolIMAAdsRequest {
  ...
  static func setUpMessageHandlers(
    ...
    let withAdsResponseChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.withAdsResponse",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      withAdsResponseChannel.setMessageHandler { message, reply in
        ...
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
            try api.pigeonDelegate.withAdsResponse(
              pigeonApi: api, adsResponse: adsResponseArg,
              adDisplayContainer: adDisplayContainerArg, contentPlayhead: contentPlayheadArg),
            withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
    ...
    let getAdTagUrlChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.getAdTagUrl",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAdTagUrlChannel.setMessageHandler { message, reply in
        ...
        do {
          let result = try api.pigeonDelegate.getAdTagUrl(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
    ...
    let getAdsResponseChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.getAdsResponse",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAdsResponseChannel.setMessageHandler { message, reply in
        ...
        let pigeonInstanceArg = args[0] as! IMAAdsRequest
        do {
          let result = try api.pigeonDelegate.getAdsResponse(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
    ...
    let getAdDisplayContainerChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.getAdDisplayContainer",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAdDisplayContainerChannel.setMessageHandler { message, reply in
        ...
        let pigeonInstanceArg = args[0] as! IMAAdsRequest
        do {
          let result = try api.pigeonDelegate.getAdDisplayContainer(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
    ...
    let setAdWillAutoPlayChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setAdWillAutoPlay",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAdWillAutoPlayChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setAdWillAutoPlay(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, adWillAutoPlay: adWillAutoPlayArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setAdWillPlayMutedChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setAdWillPlayMuted",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setAdWillPlayMutedChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setAdWillPlayMuted(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, adWillPlayMuted: adWillPlayMutedArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setContinuousPlaybackChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setContinuousPlayback",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setContinuousPlaybackChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setContinuousPlayback(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg,
            continuousPlayback: continuousPlaybackArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setContentDurationChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setContentDuration",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setContentDurationChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setContentDuration(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, duration: durationArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setContentKeywordsChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setContentKeywords",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setContentKeywordsChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setContentKeywords(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, keywords: keywordsArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setContentTitleChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setContentTitle",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setContentTitleChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setContentTitle(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, title: titleArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setContentURLChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setContentURL",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setContentURLChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setContentURL(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, contentURL: contentURLArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setVastLoadTimeoutChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setVastLoadTimeout",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setVastLoadTimeoutChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.pigeonDelegate.setVastLoadTimeout(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, timeout: timeoutArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    let setLiveStreamPrefetchSecondsChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.interactive_media_ads.IMAAdsRequest.setLiveStreamPrefetchSeconds",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMAAdsLoaderDelegate.adLoaderLoadedWith` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMAAdsLoaderDelegate.adsLoaderFailedWithErrorData` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMAAdsManagerDelegate.didReceiveAdEvent` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMAAdsManagerDelegate.didReceiveAdError` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMAAdsManagerDelegate.didRequestContentPause` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMAAdsManagerDelegate.didRequestContentResume` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMACompanionDelegate.companionAdSlotFilled` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `IMACompanionDelegate.companionSlotWasClicked` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
